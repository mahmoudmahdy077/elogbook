// CommonJS mirror of design-tokens.ts for tools that need require() (e.g., mobile tailwind config)
module.exports = {
  clinicalTokens: {
    colors: {
      ...
      statusText: { draft: '#48484A', success: '#186B2E', warning: '#8F4200', danger: '#C20012', primary: '#0066D6' },
      statusBg: { success: 'rgba(24, 107, 46, 0.08)', warning: 'rgba(143, 66, 0, 0.08)', danger: 'rgba(194, 0, 18, 0.08)' },
      statusBorder: { success: 'rgba(24, 107, 46, 0.20)', warning: 'rgba(143, 66, 0, 0.20)', danger: 'rgba(194, 0, 18, 0.20)' },
      pending: '#FF9500',
      approved: '#34C759',
      rejected: '#FF3B30',
    },
