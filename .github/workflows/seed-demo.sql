-- Adapted from supabase/migrations/00006_demo_accounts.sql for the current
-- schema: tenants.mrn_hash_salt (TEXT NOT NULL, added in 00055) is now
-- provided at insert time. Idempotent.
