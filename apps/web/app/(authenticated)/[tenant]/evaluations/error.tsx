...
export default function EvaluationsError({
  ...
  return (
    <div role="alert" className="flex items-center justify-center min-h-[40vh]">
      <div
      ...
      >
        ...
        <p className="text-sm mb-6" style={{ color: '#6D6D73' }}>
          We encountered an error while loading evaluations. Please try again.
        </p>
        <button
          onClick={reset}
        ...
        {error.digest && (
          <p className="mt-4 text-xs" style={{ color: '#AEAEB2' }}>
