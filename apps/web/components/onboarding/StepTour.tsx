...
const TOUR_ITEMS: TourItem[] = [
  {
    icon: (
      <svg className="w-6 h-6 text-fg-primary" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  {
    icon: (
      <svg className="w-6 h-6 text-fg-success" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  {
    icon: (
      <svg className="w-6 h-6 text-fg-warning" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  {
    icon: (
      <svg className="w-6 h-6 text-fg-danger" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
