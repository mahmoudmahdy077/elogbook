      ...
      {submitted ? (
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-success-50 border border-success/20">
            <svg className="w-8 h-8 text-fg-approved" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  ...
                  {!duplicateCaseId && !lastEntry && (
                    <div className="mb-3 flex justify-end">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-primary/10 text-fg-primary text-xs font-medium hover:bg-primary/20 transition-colors"
